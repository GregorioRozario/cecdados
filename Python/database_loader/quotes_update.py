...
"""
Updates table "quotes", with net worth and stock market worth for each ticker
...
def main():
    ...
    quotesUpdate = fiislib.PrimitiveIndicator(utilities, fiis_definition, 'quotes', 4, quotes_table_columns)
